    ...
    >
      <div class="container-fluid d-flex align-items-center">
        <h1 class="d-flex align-items-center fs-4 text-white mb-0">
          <img
            src="/docs/5.2/assets/brand/bootstrap-logo-white.svg"
            width="38"
            height="30"
            class="me-3"
            alt="Bootstrap"
        ...
        <a
          href="/docs/5.2/examples/cheatsheet-rtl/"
        ...
        <article class="my-3" id="typography">
          ...
          >
            ...
            <a
              ...
              href="/docs/5.2/content/typography/"
              >Documentation</a
            >
          </div>
      ...
      <section id="forms">
        ...
        <article class="my-3" id="disabled-forms">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/forms/overview/#disabled-forms"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="sizing">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/forms/form-control/#sizing"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="input-group">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/forms/input-group/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="floating-labels">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/forms/floating-labels/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="validation">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/forms/validation/"
              >Documentation</a
            >
          </div>
      ...
      <section id="components">
        ...
        <article class="my-3" id="accordion">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/accordion/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="alerts">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/alerts/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="badge">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/badge/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="breadcrumb">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/breadcrumb/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="buttons">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/buttons/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="button-group">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/button-group/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="carousel">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/carousel/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="dropdowns">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/dropdowns/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="list-group">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/list-group/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="modal">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/modal/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="navs">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/navs-tabs/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="pagination">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/pagination/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="popovers">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/popovers/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="progress">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/progress/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="scrollspy">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/scrollspy/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="spinners">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/spinners/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="toasts">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/toasts/"
              >Documentation</a
            >
          </div>
        ...
        <article class="mt-3 mb-5 pb-5" id="tooltips">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="/docs/5.2/components/tooltips/"
              >Documentation</a
            >
          </div>
...
<div class="container">
      <info-card level="info">
      <template #message>
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Impedit,
          officiis deleniti iste sequi maiores reiciendis obcaecati consectetur
          laudantium itaque sed recusandae autem explicabo? Soluta minus modi
          magni corrupti totam deserunt?
        </p>
      </template>
      <message> </message>
    </info-card>
     
     <info-card level="warn">
      <template #message>
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Impedit,
          officiis deleniti iste sequi maiores reiciendis obcaecati consectetur
